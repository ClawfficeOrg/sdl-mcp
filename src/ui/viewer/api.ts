...
export type SymbolCard = { symbolId?: string; name?: string; kind?: string; signature?: unknown; summary?: string; testCase?: { framework: string; title: string; suitePath?: string[]; category?: "test" | "benchmark" | "example" | "fuzz"; modifiers?: Array<"skip" | "todo" | "only" | "parameterized"> }; metrics?: Record<string, unknown>; deps?: { in?: Array<{ symbolId?: string; name?: string; kind?: string }>; out?: Array<{ symbolId?: string; name?: string; kind?: string }> } };
