  ...
  before(async () => {
    ...
    const ingressTargets = [
      [
        ...
        "method",
        "registerTool",
        "Register tool contracts with validated input and deterministic output shapes.",
      ],
      [
        "ingress-server-error",
        "file-ingress-server",
        ...
        "Build safe error responses with deterministic structured output.",
      ],
      [
        "ingress-descriptor-contract",
        ...
        "Flatten tool contracts in deterministic order without output noise.",
      ],
      [
        "ingress-descriptor-output",
        "file-ingress-server",
        "function",
        "asStructuredContent",
        "Shape model-facing envelopes predictably while omitting irrelevant fields.",
      ],
      [
        "ingress-runtime-determinism",
        ...
        "Read bounded command output with deterministic responses and no output noise.",
      ],
      [
